...
class Search {
  ...
  async getResults() {
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_0___default().get(esstiData.root_url + '/wp-json/essti/v1/search?keyword=' + this.searchField.value);
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkessti_theme"] = self["webpackChunkessti_theme"] || [];
